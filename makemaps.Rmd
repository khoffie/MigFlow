...
## lapply won't work
lapply(ages, function(age) dt_geog[agegroup == age])

make_agemaps(dt_geog[agegroup == "below18"])
make_agemaps(dt_geog[agegroup == "18-25"])
make_agemaps(dt_geog[agegroup == "25-30"])
make_agemaps(dt_geog[agegroup == "30-50"])
make_agemaps(dt_geog[agegroup == "50-65"])
make_agemaps(dt_geog[agegroup == "above65"])
