...
f_optis <- "opts1greater0.csv"
f_preds <- "preds1greater0.csv"
...
kable(head(dt[order(actual)]), digits = 2, caption = "Predictions for smallest actual od-flows")
kable(head(dt[order(- actual)]), digits = 2, caption = "Predictions for largest actual od-flows")
...
kable(dcast(dt_sym, variable + type ~ agegroup, value.var = "value"),
      digits = 2, caption = "Are our predictions symmetric? Berlin - Leipzig" )
