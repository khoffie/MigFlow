...
kable(head(dt[order(actual)], 10), digits = 2, caption = "Predictions for smallest actual od-flows")
kable(head(dt[order(- actual)], 10), digits = 2, caption = "Predictions for largest actual od-flows")
...
kable(dcast(dt_sym, variable + type ~ agegroup, value.var = "value"),
      digits = 2, caption = "Are our predictions symmetric?" )
