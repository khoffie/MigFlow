...
plotgeoyears(dfgeo, shp, st, "below18", plotyears)
## save("mapbelow18.pdf", plotgeoyears(dfgeo, shp, "below18", plotyears), size = (600, 400))

```

![Geographic desirability](mapbelow18.svg){width=120%}
